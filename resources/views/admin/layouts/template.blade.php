            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="index.html" class="app-brand-link">
                        <h3 class="app-brand-text demo menu-text fw-bolder my-4">SingleEcom</h3>
                    </a>
                ...
                <ul class="menu-inner py-1">
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="{{ route('allsubcategory') }}" class="menu-link">
                                    <div data-i18n="Without menu">All Subcategory</div>
                                </a>
                            </li>
                            <li class="menu-item">
                    ...
                    <li class="menu-header small text-uppercase">
                        <span class="menu-header-text">Mange Order</span>
                    </li>
                    <li class="menu-item">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                            <i class="menu-icon tf-icons bx bx-layout"></i>
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="{{ route('pendingorders') }}" class="menu-link">
                                    <div data-i18n="Without menu">Pending Product</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="layouts-without-menu.html" class="menu-link">
                                    <div data-i18n="Without menu">Completed Order</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="layouts-without-menu.html" class="menu-link">
                                    <div data-i18n="Without menu">Cancel Order</div>
                                </a>
                            </li>
                        </ul>
                    </li>
